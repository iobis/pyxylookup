import sys
sys.path.insert(0, "../pyxylookup")  # replace with the actual path
...
class Test(unittest.TestCase):
    ...
    def test_lookup_points_array(self):
        """lookup - points array"""
    ...
    def test_lookup_numpy_points(self):
        """lookup - numpy points"""
    ...
    def test_lookup_pandas_points(self):
        """lookup - numpy points"""
        points = np.asarray(test_points)
        r = xy.lookup(points)
        assert len(r) == len(test_points)
    ...
    def test_lookup_points_tuples_list(self):
    ...
    def test_lookup_asdataframe(self):
        """lookup - asdataframe"""
    ...
    def test_lookup_all_false(self):
    ...
    def test_lookup_wrong_points(self):
        """Expect error when all parameters are False"""
        @raises(ValueError)
    ...
    def test_lookup_many_points(self):
        """Lookup many points"""
        import random
        random.seed(42)
    ...
    def test_lookup_duplicate_points(self):
    ...
    def test_lookup_na_points(self):
        """Lookup NA points"""
        import math
